...
<html>
<head>
<title>RoyalTravel bootstrap Design website | Home :: w3layouts</title>
...
<tr><td colspan="2" class="toptd">Update Trip</td></tr>
<tr><td class="lefttxt">Select Trip</td><td><select name="s1" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Trip Name</td><td><input type="text"  value="<?php if(isset($_POST["show"])){ echo $Packname ;} ?> " name="t1" required pattern="[a-zA-z _]{1,50}" title"Please Enter Only Characters between 1 to 50 for Package Name"/></td></tr>
...
<tr><td class="lefttxt">Trip Price</td><td><input type="text" name="t8" value="<?php if(isset($_POST["show"])){ echo $Packprice ;} ?> " /></td></tr>
